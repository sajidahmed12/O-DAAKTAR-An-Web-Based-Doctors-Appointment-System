        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="appoinment.php"><i class="fa fa-bar-chart-o"></i> Appoinment </a>
                    </li>
                    <li>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 New Appoinments  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
									...
									{	
										...
										if($co=="Not Conform")
										{
											echo"<tr>
												...
												<th>".$trow['Email']."</th>
												<th>".$trow['Country']."</th>
												<th>".$trow['Doc_speciality']."</th>
												<th>".$trow['Area_Sel']."</th>
												<th>".$trow['VDate']."</th>	
												<th>".$trow['Status']."</th>
												
												<th><a href='appoinment.php?rid=".$trow['id']." ' class='btn btn-primary'>Action</a></th>
												</tr>";
										}	
